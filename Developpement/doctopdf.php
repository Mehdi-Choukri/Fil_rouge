...
$document = new Document();
    if($document->findDocument(Input::get('Num')))
    {
        ...
        $dateInfrench =  $dateInfrench->getDayOfTheWeek() .' ' .$dateInfrench->getDate() .' '.$dateInfrench->getMonth().' '.$dateInfrench->getYear() ;
        ...
        if($TYPE_DOC === 'MISE')
        {
                ...
                $pdfData .='<p style="margin-left:250px;font-weight:bold;font-size:21px">Safi, le '.  $dateInfrench  .'</p>';
            ...
            else
            {
                ...
                $pdfData ='';
                $pdfData .='<img src="../Images/logo-ocp-doc.jpg" width="80" height="110" style="margin-left:50px;" alt="">';
                $pdfData .='<p style="margin-left:250px;font-weight:bold;font-size:13px">Safi, le '.  $dateInfrench  .'</p>';
